      ...
      <li><a href="login.php" class="none">Login</a></li>
        ...
        <div class="ppt">
         <table  cellpadding="2" cellspacing="2" width="100%"><tr><td><h2><a href="personal.php" class="none">Personal_info</a></h2>
              ...
              </td><td class="table"><h2><a href="choice.php" class="none1">Program Choice</a></h2>
...
$connection = new mysqli("localhost","root","","umuregistration");
    ...
    if (isset($_POST['continue'])) {
      ...
      $Certificate_choice1 = $_POST['Certificate_choice1'];
      $Certificate_choice2 = $_POST['Certificate_choice2'];
      $Certificate_choice3 = $_POST['Certificate_choice3'];
      $Certificate_choice4 = $_POST['Certificate_choice4'];
      $Certificate_choice5 = $_POST['Certificate_choice5'];
      $Certificate_choice6 = $_POST['Certificate_choice6'];

      $Diploma_choice1 = $_POST['Diploma_choice1'];
      $Diploma_choice2 = $_POST['Diploma_choice2'];
      $Diploma_choice3 = $_POST['Diploma_choice3'];
      $Diploma_choice4 = $_POST['Diploma_choice4'];
      $Diploma_choice5 = $_POST['Diploma_choice5'];
      $Diploma_choice6 = $_POST['Diploma_choice6'];

        $Bachelor_choice1 = $_POST['Bachelor_choice1'];
         $Bachelor_choice2 = $_POST['Bachelor_choice2'];
          $Bachelor_choice3 = $_POST['Bachelor_choice3'];
           $Bachelor_choice4 = $_POST['Bachelor_choice4'];
            $Bachelor_choice5 = $_POST['Bachelor_choice5'];
             $Bachelor_choice6 = $_POST['Bachelor_choice6'];

             $Diplong1 = $_POST['Diplong1'];
             $Diplong2 = $_POST['Diplong2'];
             $Diplong3 = $_POST['Diplong3'];

               $Bachelorlong1 = $_POST['Bachelorlong1'];
                $Bachelorlong2 = $_POST['Bachelorlong2'];
                 $Bachelorlong3 = $_POST['Bachelorlong3'];

     
    $query = "INSERT INTO choices (Certificate_choice1,Certificate_choice2,Certificate_choice3,Certificate_choice4,Certificate_choice5,Certificate_choice6,Diploma_choice1,Diploma_choice2,Diploma_choice3,Diploma_choice4,Diploma_choice5,Diploma_choice6,Bachelor_choice1,Bachelor_choice2,Bachelor_choice3,Bachelor_choice4,Bachelor_choice5,Bachelor_choice6,Diplong1,Diplong2,Diplong3,Bachelorlong1,Bachelorlong2,Bachelorlong3)
                    VALUES ('$Certificate_choice1','$Certificate_choice2','$Certificate_choice3','$Certificate_choice4','$Certificate_choice5','$Certificate_choice6','$Diploma_choice1','$Diploma_choice2','$Diploma_choice3','$Diploma_choice4','$Diploma_choice5','$Diploma_choice6','$Bachelor_choice1','$Bachelor_choice2','$Bachelor_choice3','$Bachelor_choice4','$Bachelor_choice5','$Bachelor_choice6','$Diplong1','$Diplong2','$Diplong3','$Bachelorlong1','$Bachelorlong2','$Bachelorlong3')";

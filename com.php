    ...
    <div class="mak">
        ...
        <div class="ppt">
            <table cellpadding="2" cellspacing="2" width="100%"><tr><td><h2><a href="personal.php" class="none">Personal_info</a></h2>
                      ...
                      </td><td class="table"><h2><a href="com.php" class="none1">Confirmation</a></h2></td></tr></table>
               </div>
        <div class="per">
        <b>Confirmation</b>
        </div>
        <div class="ffs">
        <fieldset>
        Thank you for applying to Uganda Martyrs University. Your application verifications and Number will be sent to your email.<br>Please endever to check for your administion details.
        
        <h2><i>NOTE</i></h2><i>your application will be accepted only after your payment has been recieved.</i><br>
        ACCount no<br>
        039857653456.centinary bank<br>
        043883776647.centinary bank<br>
